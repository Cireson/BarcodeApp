...
public class ZXingFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private boolean calledAfterResume;
	...
	public void onResume() {
        ...
        getView().getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                setupScannerOnResume();
            }
        });
}

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    private void setupScannerOnResume(){
        if(!calledAfterResume) {
            calledAfterResume = true;
            ZXingFragment.this.getResources().getDimensionPixelSize(R.dimen.scanner_preview_height);
            cameraManager.setManualFramingRect(getView().getWidth(), ZXingFragment.this.getResources().getDimensionPixelSize(R.dimen.scanner_preview_height));
            ...
            if (hasSurface) {
                ...
                // camera.
                surfaceHolder.addCallback(ZXingFragment.this);
