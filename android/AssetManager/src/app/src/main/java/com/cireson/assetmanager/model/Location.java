 ...
 */
public class Location extends AssetAttributeBase {
    /*Instances..*/
    ...
    public Location(){
        ...
        simpExp.typeId = CiresonConstants.Location_Type;
        simpExp.relationshipTypeId = CiresonConstants.HardwareAsset_HasLocation_RelationshipType;
    ...
    public boolean equals(Object o) {
        ...
        if(o!=null && o.getClass()==Location.class){
            isEqual = ((Location)o).displayName.equals(displayName);
        }
        return isEqual;
    }
}
