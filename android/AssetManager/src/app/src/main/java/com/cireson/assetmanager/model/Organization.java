 ...
 */
public class Organization extends AssetAttributeBase {
    /*Instances..*/
    ...
    public Organization(){
        ...
        simpExp.typeId = CiresonConstants.Organization_Type;
        simpExp.relationshipTypeId = CiresonConstants.HardwareAsset_HasOrganization_RelationshipType;
    ...
    public boolean equals(Object o) {
        ...
        if(o!=null && o.getClass()==Organization.class){
            isEqual = ((Organization)o).displayName.equals(displayName);
        }
        return isEqual;
    }
}
