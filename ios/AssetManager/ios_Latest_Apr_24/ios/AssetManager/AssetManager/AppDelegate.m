...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    if ([User loggedInUser] != Nil) {
        ...
        [[CiresonApiService sharedService] setBaseUrl:[User loggedInUser].url];
        UIViewController *homeViewController = [storyboard instantiateViewControllerWithIdentifier:@"navigation"];
...
-(void)printCurrentWorkflow {
    if (self.workFlow == ReceiveAssetByPO) {
        NSLog(@"%@", @"ReceiveAssetByPO");
    }
    else if (self.workFlow == InventoryAudit) {
        NSLog(@"%@", @"InventoryAudit");
    }
    else if (self.workFlow == SwapAsset) {
        NSLog(@"%@", @"SwapAsset");
    }
    else if (self.workFlow == EditAsset) {
        NSLog(@"%@", @"EditAsset");
    }
    else if (self.workFlow == DisposeAsset) {
        NSLog(@"%@", @"DisposeAsset");
    }
    else if (self.workFlow == AddAssets) {
        NSLog(@"%@", @"AddAssets");
    }
    else {
        NSLog(@"%@", @"Unrecognized");
