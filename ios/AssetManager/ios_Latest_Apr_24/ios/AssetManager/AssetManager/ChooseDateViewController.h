...
@required
-(void)didFinishChoosingDate:(NSDate*)date affectedProperty:(AssetProperties)property; // nil means none selected
@end

@interface ChooseDateViewController : CiresonViewController

@property (weak, nonatomic) IBOutlet UIDatePicker* pickerView;
@property (strong, nonatomic) NSDate* selectedDate;
@property (assign, nonatomic) AssetProperties affectedProperty;
